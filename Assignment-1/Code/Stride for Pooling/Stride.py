...
train_data_dir = '../5/train' # put path of training dataset
val_data_dir = '../5/val' # put path of test dataset
test_data_dir = '../5/test' # put path of test dataset
...
num_epochs = 40         # desired number of training epochs.
learning_rate = 0.001   
...
class Net(nn.Module):
    def __init__(self,m):
        ...
        self.pool = nn.MaxPool2d(kernel_size=2, stride=m)
        self.fc1 = nn.Linear(in_features=256, out_features=256)
        self.fc2 = nn.Linear(in_features=256, out_features=128)
        self.fc3 = nn.Linear(in_features=128, out_features=33) # 5 is the number of classes here (for batch 3,4,5 out_features is 33)
...
for e in Strides:
    ...
    print("Stride for this testing is "+str(e))
